...
MODULE_DESCRIPTION("center-aligned - loadable module template generated by petalinux-create -t modules");
...
static bool Pwm_Init(void)
{
    ...
    axi_write32_safe(CenterAligned_base, CTRL,
                     (1 << PWM_ENABLE) | (1 << PWM_CENTER_ALIGNED) | (1 << PWM_INTERRUPT_ENABLE));
